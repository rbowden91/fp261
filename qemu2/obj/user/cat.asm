...
cat(int f, const char *s)
{
  ...
  800043:	eb 40                	jmp    800085 <_Z3catiPKc+0x51>
		if ((r = write(1, buf, n)) != n)
  800045:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  800049:	c7 44 24 04 00 60 80 	movl   $0x806000,0x4(%esp)
  800050:	00 
  800051:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  800058:	e8 1c 17 00 00       	call   801779 <_Z5writeiPKvj>
  80005d:	39 c3                	cmp    %eax,%ebx
  80005f:	74 24                	je     800085 <_Z3catiPKc+0x51>
			panic("write error copying %s: %e", s, r);
  800061:	89 44 24 10          	mov    %eax,0x10(%esp)
  800065:	89 7c 24 0c          	mov    %edi,0xc(%esp)
  800069:	c7 44 24 08 80 3f 80 	movl   $0x803f80,0x8(%esp)
  800070:	00 
  800071:	c7 44 24 04 0d 00 00 	movl   $0xd,0x4(%esp)
  800078:	00 
  800079:	c7 04 24 9b 3f 80 00 	movl   $0x803f9b,(%esp)
  800080:	e8 83 01 00 00       	call   800208 <_Z6_panicPKciS0_z>
cat(int f, const char *s)
{
	long n;
	int r;
  ...
  80008c:	00 
  80008d:	c7 44 24 04 00 60 80 	movl   $0x806000,0x4(%esp)
  800094:	00 
  800095:	89 34 24             	mov    %esi,(%esp)
  800098:	e8 f1 15 00 00       	call   80168e <_Z4readiPvj>
  80009d:	89 c3                	mov    %eax,%ebx
  80009f:	85 c0                	test   %eax,%eax
  8000a1:	7f a2                	jg     800045 <_Z3catiPKc+0x11>
		if ((r = write(1, buf, n)) != n)
			panic("write error copying %s: %e", s, r);
	if (n < 0)
  8000a3:	85 c0                	test   %eax,%eax
  8000a5:	79 24                	jns    8000cb <_Z3catiPKc+0x97>
		panic("error reading %s: %e", s, n);
  8000a7:	89 44 24 10          	mov    %eax,0x10(%esp)
  8000ab:	89 7c 24 0c          	mov    %edi,0xc(%esp)
  8000af:	c7 44 24 08 a6 3f 80 	movl   $0x803fa6,0x8(%esp)
  8000b6:	00 
  8000b7:	c7 44 24 04 0f 00 00 	movl   $0xf,0x4(%esp)
  8000be:	00 
  8000bf:	c7 04 24 9b 3f 80 00 	movl   $0x803f9b,(%esp)
  8000c6:	e8 3d 01 00 00       	call   800208 <_Z6_panicPKciS0_z>
}
...
umain(int argc, char **argv)
{
  ...
  8000d7:	56                   	push   %esi
  8000d8:	53                   	push   %ebx
  8000d9:	83 ec 3c             	sub    $0x3c,%esp
	int f, i;

	argv0 = "cat";
  8000dc:	c7 05 04 80 80 00 bb 	movl   $0x803fbb,0x808004
  8000e3:	3f 80 00 
	if (argc == 1)
  8000e6:	83 7d 08 01          	cmpl   $0x1,0x8(%ebp)
  8000ea:	74 13                	je     8000ff <_Z5umainiPPc+0x2c>
	if (n < 0)
		panic("error reading %s: %e", s, n);
}
...
umain(int argc, char **argv)
  ...
  8000f2:	bf 01 00 00 00       	mov    $0x1,%edi
	...
	if (argc == 1)
		...
		for (i = 1; i < argc; i++) {
  8000f7:	83 7d 08 01          	cmpl   $0x1,0x8(%ebp)
  8000fb:	7f 18                	jg     800115 <_Z5umainiPPc+0x42>
  8000fd:	eb 7b                	jmp    80017a <_Z5umainiPPc+0xa7>
{
	int f, i;
	...
	if (argc == 1)
		cat(0, "<stdin>");
  8000ff:	c7 44 24 04 bf 3f 80 	movl   $0x803fbf,0x4(%esp)
  800106:	00 
  800107:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  80010e:	e8 21 ff ff ff       	call   800034 <_Z3catiPKc>
  800113:	eb 65                	jmp    80017a <_Z5umainiPPc+0xa7>
  800115:	89 5d e4             	mov    %ebx,-0x1c(%ebp)
	else
		for (i = 1; i < argc; i++) {
			f = open(argv[i], O_RDONLY);
  800118:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  80011f:	00 
  800120:	8b 03                	mov    (%ebx),%eax
  800122:	89 04 24             	mov    %eax,(%esp)
  800125:	e8 f4 21 00 00       	call   80231e <_Z4openPKci>
  80012a:	89 c6                	mov    %eax,%esi
			if (f < 0)
  80012c:	85 c0                	test   %eax,%eax
  80012e:	79 29                	jns    800159 <_Z5umainiPPc+0x86>
				panic("can't open %s: %e", argv[i], f);
  800130:	89 44 24 10          	mov    %eax,0x10(%esp)
  800134:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  800137:	8b 02                	mov    (%edx),%eax
  800139:	89 44 24 0c          	mov    %eax,0xc(%esp)
  80013d:	c7 44 24 08 c7 3f 80 	movl   $0x803fc7,0x8(%esp)
  800144:	00 
  800145:	c7 44 24 04 1e 00 00 	movl   $0x1e,0x4(%esp)
  80014c:	00 
  80014d:	c7 04 24 9b 3f 80 00 	movl   $0x803f9b,(%esp)
  800154:	e8 af 00 00 00       	call   800208 <_Z6_panicPKciS0_z>
			else {
				cat(f, argv[i]);
  800159:	8b 03                	mov    (%ebx),%eax
  80015b:	89 44 24 04          	mov    %eax,0x4(%esp)
  80015f:	89 34 24             	mov    %esi,(%esp)
  800162:	e8 cd fe ff ff       	call   800034 <_Z3catiPKc>
				close(f);
  800167:	89 34 24             	mov    %esi,(%esp)
  80016a:	e8 76 13 00 00       	call   8014e5 <_Z5closei>
	...
	if (argc == 1)
		...
		for (i = 1; i < argc; i++) {
  80016f:	83 c7 01             	add    $0x1,%edi
  800172:	83 c3 04             	add    $0x4,%ebx
  800175:	39 7d 08             	cmp    %edi,0x8(%ebp)
  800178:	7f 9b                	jg     800115 <_Z5umainiPPc+0x42>
			else {
				cat(f, argv[i]);
				close(f);
			}
...
libmain(int argc, char **argv)
{
  ...
  80018d:	8b 7d 08             	mov    0x8(%ebp),%edi
  800190:	8b 75 0c             	mov    0xc(%ebp),%esi
	extern uintptr_t sctors[], ectors[];
	uintptr_t *ctorva;

	// set thisenv to point at our Env structure in envs[]
	thisenv = &envs[ENVX(sys_getenvid())]; /* Really? */
  800193:	e8 20 0c 00 00       	call   800db8 <_Z12sys_getenvidv>
  800198:	25 ff 03 00 00       	and    $0x3ff,%eax
  80019d:	6b c0 78             	imul   $0x78,%eax,%eax
  8001a0:	05 00 00 00 ef       	add    $0xef000000,%eax
  8001a5:	a3 00 80 80 00       	mov    %eax,0x808000
	// save the name of the program so that panic() can use it
	if (argc > 0)
  8001aa:	85 ff                	test   %edi,%edi
  ...
  8001b5:	b8 01 4b 80 00       	mov    $0x804b01,%eax
  8001ba:	3d 01 4b 80 00       	cmp    $0x804b01,%eax
  8001bf:	76 0f                	jbe    8001d0 <libmain+0x4c>
  8001c1:	89 c3                	mov    %eax,%ebx
		((void(*)()) *--ctorva)();
  8001c3:	83 eb 04             	sub    $0x4,%ebx
  8001c6:	ff 13                	call   *(%ebx)
		binaryname = argv[0];
	...
	// 'ectors' symbols; see user/user.ld.
	for (ctorva = ectors; ctorva > sctors; )
  8001c8:	81 fb 01 4b 80 00    	cmp    $0x804b01,%ebx
  8001ce:	77 f3                	ja     8001c3 <libmain+0x3f>
		((void(*)()) *--ctorva)();

	// call user main routine
	umain(argc, argv);
  8001d0:	89 74 24 04          	mov    %esi,0x4(%esp)
  8001d4:	89 3c 24             	mov    %edi,(%esp)
  8001d7:	e8 f7 fe ff ff       	call   8000d3 <_Z5umainiPPc>

	// exit gracefully
	exit();
  8001dc:	e8 0b 00 00 00       	call   8001ec <_Z4exitv>
}
  8001e1:	83 c4 1c             	add    $0x1c,%esp
  8001e4:	5b                   	pop    %ebx
  8001e5:	5e                   	pop    %esi
  8001e6:	5f                   	pop    %edi
  8001e7:	5d                   	pop    %ebp
...
exit(void)
{
  ...
  8001ef:	83 ec 18             	sub    $0x18,%esp
	close_all();
  8001f2:	e8 27 13 00 00       	call   80151e <_Z9close_allv>
	sys_env_destroy(0);
  8001f7:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8001fe:	e8 58 0b 00 00       	call   800d5b <_Z15sys_env_destroyi>
}
  800203:	c9                   	leave  
  800204:	c3                   	ret    
  800205:	00 00                	add    %al,(%eax)
	...

00800208 <_Z6_panicPKciS0_z>:
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80020b:	56                   	push   %esi
  80020c:	53                   	push   %ebx
  80020d:	83 ec 20             	sub    $0x20,%esp
	va_list ap;

	va_start(ap, fmt);
  800210:	8d 75 14             	lea    0x14(%ebp),%esi

	// Print the panic message
	if (argv0)
  800213:	a1 04 80 80 00       	mov    0x808004,%eax
  800218:	85 c0                	test   %eax,%eax
  80021a:	74 10                	je     80022c <_Z6_panicPKciS0_z+0x24>
		cprintf("%s: ", argv0);
  80021c:	89 44 24 04          	mov    %eax,0x4(%esp)
  800220:	c7 04 24 e3 3f 80 00 	movl   $0x803fe3,(%esp)
  800227:	e8 fa 00 00 00       	call   800326 <_Z7cprintfPKcz>
	cprintf("[%08x] user panic in %s at %s:%d: ",
		sys_getenvid(), binaryname, file, line);
  80022c:	8b 1d 00 50 80 00    	mov    0x805000,%ebx
  800232:	e8 81 0b 00 00       	call   800db8 <_Z12sys_getenvidv>
  ...
  80024d:	c7 04 24 e8 3f 80 00 	movl   $0x803fe8,(%esp)
  800254:	e8 cd 00 00 00       	call   800326 <_Z7cprintfPKcz>
	vcprintf(fmt, ap);
  800259:	89 74 24 04          	mov    %esi,0x4(%esp)
  80025d:	8b 45 10             	mov    0x10(%ebp),%eax
  800260:	89 04 24             	mov    %eax,(%esp)
  800263:	e8 5d 00 00 00       	call   8002c5 <_Z8vcprintfPKcPc>
	cprintf("\n");
  800268:	c7 04 24 a3 49 80 00 	movl   $0x8049a3,(%esp)
  80026f:	e8 b2 00 00 00       	call   800326 <_Z7cprintfPKcz>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  800274:	cc                   	int3   
  800275:	eb fd                	jmp    800274 <_Z6_panicPKciS0_z+0x6c>
	...

00800278 <_ZL5putchiPv>:
};
...
putch(int ch, void *ptr)
{
  ...
  800281:	89 75 fc             	mov    %esi,-0x4(%ebp)
  800284:	8b 5d 0c             	mov    0xc(%ebp),%ebx
	struct printbuf *b = (struct printbuf *) ptr;
  800287:	89 de                	mov    %ebx,%esi
	b->buf[b->idx++] = ch;
  800289:	8b 03                	mov    (%ebx),%eax
  80028b:	8b 55 08             	mov    0x8(%ebp),%edx
  80028e:	88 54 03 08          	mov    %dl,0x8(%ebx,%eax,1)
  800292:	83 c0 01             	add    $0x1,%eax
  800295:	89 03                	mov    %eax,(%ebx)
	if (b->idx == 256-1) {
  800297:	3d ff 00 00 00       	cmp    $0xff,%eax
  80029c:	75 19                	jne    8002b7 <_ZL5putchiPv+0x3f>
		sys_cputs(b->buf, b->idx);
  80029e:	c7 44 24 04 ff 00 00 	movl   $0xff,0x4(%esp)
  8002a5:	00 
  8002a6:	8d 43 08             	lea    0x8(%ebx),%eax
  8002a9:	89 04 24             	mov    %eax,(%esp)
  8002ac:	e8 43 0a 00 00       	call   800cf4 <_Z9sys_cputsPKcj>
		b->idx = 0;
  8002b1:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
	}
	b->cnt++;
  8002b7:	83 46 04 01          	addl   $0x1,0x4(%esi)
}
  8002bb:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  8002be:	8b 75 fc             	mov    -0x4(%ebp),%esi
  8002c1:	89 ec                	mov    %ebp,%esp
  8002c3:	5d                   	pop    %ebp
  8002c4:	c3                   	ret    

008002c5 <_Z8vcprintfPKcPc>:
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8002fa:	c7 04 24 78 02 80 00 	movl   $0x800278,(%esp)
  800301:	e8 a1 01 00 00       	call   8004a7 <_Z9vprintfmtPFviPvES_PKcPc>
	sys_cputs(b.buf, b.idx);
  ...
  800319:	e8 d6 09 00 00       	call   800cf4 <_Z9sys_cputsPKcj>

	return b.cnt;
}
  80031e:	8b 85 f4 fe ff ff    	mov    -0x10c(%ebp),%eax
  800324:	c9                   	leave  
  800325:	c3                   	ret    

00800326 <_Z7cprintfPKcz>:
...
cprintf(const char *fmt, ...)
{
  ...
  800339:	e8 87 ff ff ff       	call   8002c5 <_Z8vcprintfPKcPc>
	va_end(ap);
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8003af:	e8 5c 39 00 00       	call   803d10 <__udivdi3>
  ...
  80040a:	e8 11 3a 00 00       	call   803e20 <__umoddi3>
  80040f:	89 74 24 04          	mov    %esi,0x4(%esp)
  800413:	0f be 80 0b 40 80 00 	movsbl 0x80400b(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800554:	ff 24 85 a0 41 80 00 	jmp    *0x8041a0(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  80060d:	8b 14 85 00 43 80 00 	mov    0x804300(,%eax,4),%edx
  ...
  800620:	c7 44 24 08 23 40 80 	movl   $0x804023,0x8(%esp)
  800627:	00 
  ...
  800652:	ba 1c 40 80 00       	mov    $0x80401c,%edx
...
getint(va_list *ap, int lflag)
{
  ...
  800855:	c7 44 24 08 9e 43 80 	movl   $0x80439e,0x8(%esp)
  80085c:	00 
...
sys_env_destroy(envid_t envid)
{
  ...
  800d8e:	00 
  800d8f:	c7 44 24 08 54 43 80 	movl   $0x804354,0x8(%esp)
  800d96:	00 
  800d97:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d9e:	00 
  800d9f:	c7 04 24 71 43 80 00 	movl   $0x804371,(%esp)
  800da6:	e8 5d f4 ff ff       	call   800208 <_Z6_panicPKciS0_z>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800e55:	00 
  800e56:	c7 44 24 08 54 43 80 	movl   $0x804354,0x8(%esp)
  800e5d:	00 
  800e5e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e65:	00 
  800e66:	c7 04 24 71 43 80 00 	movl   $0x804371,(%esp)
  800e6d:	e8 96 f3 ff ff       	call   800208 <_Z6_panicPKciS0_z>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800eb3:	00 
  800eb4:	c7 44 24 08 54 43 80 	movl   $0x804354,0x8(%esp)
  800ebb:	00 
  800ebc:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ec3:	00 
  800ec4:	c7 04 24 71 43 80 00 	movl   $0x804371,(%esp)
  800ecb:	e8 38 f3 ff ff       	call   800208 <_Z6_panicPKciS0_z>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800f11:	00 
  800f12:	c7 44 24 08 54 43 80 	movl   $0x804354,0x8(%esp)
  800f19:	00 
  800f1a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800f21:	00 
  800f22:	c7 04 24 71 43 80 00 	movl   $0x804371,(%esp)
  800f29:	e8 da f2 ff ff       	call   800208 <_Z6_panicPKciS0_z>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800f6f:	00 
  800f70:	c7 44 24 08 54 43 80 	movl   $0x804354,0x8(%esp)
  800f77:	00 
  800f78:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800f7f:	00 
  800f80:	c7 04 24 71 43 80 00 	movl   $0x804371,(%esp)
  800f87:	e8 7c f2 ff ff       	call   800208 <_Z6_panicPKciS0_z>
...
sys_env_set_priority(envid_t envid, int priority)
{
  ...
  800fcd:	00 
  800fce:	c7 44 24 08 54 43 80 	movl   $0x804354,0x8(%esp)
  800fd5:	00 
  800fd6:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800fdd:	00 
  800fde:	c7 04 24 71 43 80 00 	movl   $0x804371,(%esp)
  800fe5:	e8 1e f2 ff ff       	call   800208 <_Z6_panicPKciS0_z>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  80102b:	00 
  80102c:	c7 44 24 08 54 43 80 	movl   $0x804354,0x8(%esp)
  801033:	00 
  801034:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80103b:	00 
  80103c:	c7 04 24 71 43 80 00 	movl   $0x804371,(%esp)
  801043:	e8 c0 f1 ff ff       	call   800208 <_Z6_panicPKciS0_z>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  801089:	00 
  80108a:	c7 44 24 08 54 43 80 	movl   $0x804354,0x8(%esp)
  801091:	00 
  801092:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  801099:	00 
  80109a:	c7 04 24 71 43 80 00 	movl   $0x804371,(%esp)
  8010a1:	e8 62 f1 ff ff       	call   800208 <_Z6_panicPKciS0_z>
...
sys_ipc_recv(void *dstva)
{
  ...
  80111e:	00 
  80111f:	c7 44 24 08 54 43 80 	movl   $0x804354,0x8(%esp)
  801126:	00 
  801127:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80112e:	00 
  80112f:	c7 04 24 71 43 80 00 	movl   $0x804371,(%esp)
  801136:	e8 cd f0 ff ff       	call   800208 <_Z6_panicPKciS0_z>
...
fd_isopen(const struct Fd *fd)
{
  ...
  801294:	c7 44 24 0c 7f 43 80 	movl   $0x80437f,0xc(%esp)
  80129b:	00 
  80129c:	c7 44 24 08 8c 43 80 	movl   $0x80438c,0x8(%esp)
  8012a3:	00 
  8012a4:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
  8012ab:	00 
  8012ac:	c7 04 24 a1 43 80 00 	movl   $0x8043a1,(%esp)
  8012b3:	e8 50 ef ff ff       	call   800208 <_Z6_panicPKciS0_z>
...
fd2num(struct Fd *fd)
{
  ...
  801349:	c7 44 24 0c 7f 43 80 	movl   $0x80437f,0xc(%esp)
  801350:	00 
  801351:	c7 44 24 08 8c 43 80 	movl   $0x80438c,0x8(%esp)
  801358:	00 
  801359:	c7 44 24 04 3d 00 00 	movl   $0x3d,0x4(%esp)
  801360:	00 
  801361:	c7 04 24 a1 43 80 00 	movl   $0x8043a1,(%esp)
  801368:	e8 9b ee ff ff       	call   800208 <_Z6_panicPKciS0_z>
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  801404:	39 0d 04 50 80 00    	cmp    %ecx,0x805004
...
dev_lookup(int dev_id, struct Dev **dev)
{
	int i;
	for (i = 0; devtab[i]; i++)
  801414:	ba 04 50 80 00       	mov    $0x805004,%edx
		if (devtab[i]->dev_id == dev_id) {
			*dev = devtab[i];
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  801425:	8b 14 85 0c 44 80 00 	mov    0x80440c(,%eax,4),%edx
  ...
  801430:	a1 00 80 80 00       	mov    0x808000,%eax
  801435:	8b 40 04             	mov    0x4(%eax),%eax
  801438:	89 4c 24 08          	mov    %ecx,0x8(%esp)
  80143c:	89 44 24 04          	mov    %eax,0x4(%esp)
  801440:	c7 04 24 c8 43 80 00 	movl   $0x8043c8,(%esp)
  801447:	e8 da ee ff ff       	call   800326 <_Z7cprintfPKcz>
	*dev = 0;
  ...
  8016ba:	8b 45 f0             	mov    -0x10(%ebp),%eax
{
  ...
  8016cd:	a1 00 80 80 00       	mov    0x808000,%eax
  8016d2:	8b 40 04             	mov    0x4(%eax),%eax
  8016d5:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  8016d9:	89 44 24 04          	mov    %eax,0x4(%esp)
  8016dd:	c7 04 24 aa 43 80 00 	movl   $0x8043aa,(%esp)
  8016e4:	e8 3d ec ff ff       	call   800326 <_Z7cprintfPKcz>
		return -E_INVAL;
  ...
  80184b:	8b 45 f0             	mov    -0x10(%ebp),%eax
{
  ...
  80185e:	a1 00 80 80 00       	mov    0x808000,%eax
  801863:	8b 40 04             	mov    0x4(%eax),%eax
  801866:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  80186a:	89 44 24 04          	mov    %eax,0x4(%esp)
  80186e:	c7 04 24 e8 43 80 00 	movl   $0x8043e8,(%esp)
  801875:	e8 ac ea ff ff       	call   800326 <_Z7cprintfPKcz>
		return -E_INVAL;
...
stat_base(const struct Inode *ino, struct Stat *stat)
{
  ...
  8019ce:	89 42 7c             	mov    %eax,0x7c(%edx)
	stat->st_dev = &devfile;
  8019d1:	c7 82 80 00 00 00 04 	movl   $0x805004,0x80(%edx)
  8019d8:	50 80 00 
}
  8019db:	5d                   	pop    %ebp
  8019dc:	c3                   	ret    
...
get_inode(int inum)
{
  ...
  8019f9:	c7 44 24 08 20 44 80 	movl   $0x804420,0x8(%esp)
  801a00:	00 
  801a01:	c7 44 24 04 47 00 00 	movl   $0x47,0x4(%esp)
  801a08:	00 
  801a09:	c7 04 24 36 44 80 00 	movl   $0x804436,(%esp)
  801a10:	e8 f3 e7 ff ff       	call   800208 <_Z6_panicPKciS0_z>
// The inode might not be in memory right now (it should be demand paged).
//
static struct Inode *
get_inode(int inum)
...
bcache_ipc(void *addr, int reqtype)
{
  ...
  801a58:	c7 44 24 08 5c 44 80 	movl   $0x80445c,0x8(%esp)
  801a5f:	00 
  801a60:	c7 44 24 04 1f 00 00 	movl   $0x1f,0x4(%esp)
  801a67:	00 
  801a68:	c7 04 24 36 44 80 00 	movl   $0x804436,(%esp)
  801a6f:	e8 94 e7 ff ff       	call   800208 <_Z6_panicPKciS0_z>
  ...
  801a97:	c7 44 24 08 8c 44 80 	movl   $0x80448c,0x8(%esp)
  801a9e:	00 
  801a9f:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%esp)
  801aa6:	00 
  801aa7:	c7 04 24 36 44 80 00 	movl   $0x804436,(%esp)
  801aae:	e8 55 e7 ff ff       	call   800208 <_Z6_panicPKciS0_z>
...
inode_open(int inum, struct Inode **ino_store)
{
  ...
  801b11:	e8 05 20 00 00       	call   803b1b <_Z19add_pgfault_handlerPFvP10UTrapframeE>
...
bcache_pgfault_handler(struct UTrapframe *utf)
{
  ...
  801dc1:	c7 44 24 08 41 44 80 	movl   $0x804441,0x8(%esp)
  801dc8:	00 
  801dc9:	c7 44 24 04 3a 00 00 	movl   $0x3a,0x4(%esp)
  801dd0:	00 
  801dd1:	c7 04 24 36 44 80 00 	movl   $0x804436,(%esp)
  801dd8:	e8 2b e4 ff ff       	call   800208 <_Z6_panicPKciS0_z>
    resume(utf);
  801ddd:	89 1c 24             	mov    %ebx,(%esp)
  801de0:	e8 0b 1e 00 00       	call   803bf0 <resume>
}
  ...
  80248b:	e8 65 f8 ff ff       	call   801cf5 <_ZL11inode_closeP5Inode>
{
  ...
  8024c6:	8b 15 04 50 80 00    	mov    0x805004,%edx
...
err2:
  ...
  80253e:	a1 00 80 80 00       	mov    0x808000,%eax
...
istat(inum_t inum, struct Stat *stat)
{
  ...
  802583:	c7 44 24 04 54 44 80 	movl   $0x804454,0x4(%esp)
  80258a:	00 
...
fsck(void)
{
  ...
  802656:	e8 c0 14 00 00       	call   803b1b <_Z19add_pgfault_handlerPFvP10UTrapframeE>
  ...
  802673:	c7 44 24 08 bc 44 80 	movl   $0x8044bc,0x8(%esp)
  80267a:	00 
  80267b:	c7 44 24 04 1b 03 00 	movl   $0x31b,0x4(%esp)
  802682:	00 
  802683:	c7 04 24 36 44 80 00 	movl   $0x804436,(%esp)
  80268a:	e8 79 db ff ff       	call   800208 <_Z6_panicPKciS0_z>
  ...
  802699:	c7 44 24 08 f0 44 80 	movl   $0x8044f0,0x8(%esp)
  8026a0:	00 
  8026a1:	c7 44 24 04 1d 03 00 	movl   $0x31d,0x4(%esp)
  8026a8:	00 
  8026a9:	c7 04 24 36 44 80 00 	movl   $0x804436,(%esp)
  8026b0:	e8 53 db ff ff       	call   800208 <_Z6_panicPKciS0_z>
  ...
  8026bf:	c7 44 24 08 20 45 80 	movl   $0x804520,0x8(%esp)
  8026c6:	00 
  8026c7:	c7 44 24 04 1f 03 00 	movl   $0x31f,0x4(%esp)
  8026ce:	00 
  8026cf:	c7 04 24 36 44 80 00 	movl   $0x804436,(%esp)
  8026d6:	e8 2d db ff ff       	call   800208 <_Z6_panicPKciS0_z>
  ...
  802728:	c7 44 24 08 50 45 80 	movl   $0x804550,0x8(%esp)
  80272f:	00 
  802730:	c7 44 24 04 24 03 00 	movl   $0x324,0x4(%esp)
  802737:	00 
  802738:	c7 04 24 36 44 80 00 	movl   $0x804436,(%esp)
  80273f:	e8 c4 da ff ff       	call   800208 <_Z6_panicPKciS0_z>
  ...
  802774:	c7 04 24 94 45 80 00 	movl   $0x804594,(%esp)
  80277b:	e8 a6 db ff ff       	call   800326 <_Z7cprintfPKcz>
			++errors;
  ...
  80279b:	c7 04 24 c8 45 80 00 	movl   $0x8045c8,(%esp)
  8027a2:	e8 7f db ff ff       	call   800326 <_Z7cprintfPKcz>
			++errors;
  ...
  802839:	c7 04 24 f4 45 80 00 	movl   $0x8045f4,(%esp)
  802840:	e8 e1 da ff ff       	call   800326 <_Z7cprintfPKcz>
			++errors;
  ...
  802861:	c7 04 24 18 46 80 00 	movl   $0x804618,(%esp)
  802868:	e8 b9 da ff ff       	call   800326 <_Z7cprintfPKcz>
			++errors;
  ...
  802881:	c7 04 24 4c 46 80 00 	movl   $0x80464c,(%esp)
  802888:	e8 99 da ff ff       	call   800326 <_Z7cprintfPKcz>
			++errors;
  ...
  8028c4:	c7 04 24 7c 46 80 00 	movl   $0x80467c,(%esp)
  8028cb:	e8 56 da ff ff       	call   800326 <_Z7cprintfPKcz>
			++errors;
  ...
  802904:	c7 04 24 a0 46 80 00 	movl   $0x8046a0,(%esp)
  80290b:	e8 16 da ff ff       	call   800326 <_Z7cprintfPKcz>
			++errors;
...
fsck(void)
  ...
  802967:	c7 04 24 c4 46 80 00 	movl   $0x8046c4,(%esp)
  80296e:	e8 b3 d9 ff ff       	call   800326 <_Z7cprintfPKcz>
				++errors;
  ...
  80299f:	c7 04 24 08 47 80 00 	movl   $0x804708,(%esp)
  8029a6:	e8 7b d9 ff ff       	call   800326 <_Z7cprintfPKcz>
				++errors;
  ...
  8029e1:	c7 04 24 4c 47 80 00 	movl   $0x80474c,(%esp)
  8029e8:	e8 39 d9 ff ff       	call   800326 <_Z7cprintfPKcz>
					++errors;
  ...
  802a13:	c7 04 24 90 47 80 00 	movl   $0x804790,(%esp)
  802a1a:	e8 07 d9 ff ff       	call   800326 <_Z7cprintfPKcz>
					++errors;
  ...
  802a3e:	c7 04 24 cc 47 80 00 	movl   $0x8047cc,(%esp)
  802a45:	e8 dc d8 ff ff       	call   800326 <_Z7cprintfPKcz>
					++errors;
  ...
  802b46:	c7 04 24 08 48 80 00 	movl   $0x804808,(%esp)
  802b4d:	e8 d4 d7 ff ff       	call   800326 <_Z7cprintfPKcz>
			++errors;
  ...
  802ba7:	c7 04 24 3c 48 80 00 	movl   $0x80483c,(%esp)
  802bae:	e8 73 d7 ff ff       	call   800326 <_Z7cprintfPKcz>
				++errors;
  ...
  802bd1:	c7 04 24 68 48 80 00 	movl   $0x804868,(%esp)
  802bd8:	e8 49 d7 ff ff       	call   800326 <_Z7cprintfPKcz>
				++errors;
  ...
  802c46:	c7 04 24 9c 48 80 00 	movl   $0x80489c,(%esp)
  802c4d:	e8 d4 d6 ff ff       	call   800326 <_Z7cprintfPKcz>
				++errors;
  ...
  802cfd:	c7 04 24 cc 48 80 00 	movl   $0x8048cc,(%esp)
  802d04:	e8 1d d6 ff ff       	call   800326 <_Z7cprintfPKcz>
					++errors;
  ...
  802d59:	c7 04 24 fc 48 80 00 	movl   $0x8048fc,(%esp)
  802d60:	e8 c1 d5 ff ff       	call   800326 <_Z7cprintfPKcz>
					++errors;
...
fsck(void)
  ...
  802e1c:	c7 04 24 2c 49 80 00 	movl   $0x80492c,(%esp)
  802e23:	e8 fe d4 ff ff       	call   800326 <_Z7cprintfPKcz>
			++errors;
  ...
  802e74:	c7 04 24 58 49 80 00 	movl   $0x804958,(%esp)
  802e7b:	e8 a6 d4 ff ff       	call   800326 <_Z7cprintfPKcz>
			++errors;
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  802edc:	c7 44 24 04 8b 49 80 	movl   $0x80498b,0x4(%esp)
  802ee3:	00 
  ...
  802ef4:	c7 46 7c 01 00 00 00 	movl   $0x1,0x7c(%esi)
	stat->st_dev = &devpipe;
  802efb:	c7 86 80 00 00 00 20 	movl   $0x805020,0x80(%esi)
  802f02:	50 80 00 
	return 0;
}
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  802f5a:	a1 00 80 80 00       	mov    0x808000,%eax
  ...
  802f7f:	8b 15 00 80 80 00    	mov    0x808000,%edx
  ...
  802f96:	74 c2                	je     802f5a <_ZL13_pipeisclosedP2FdP4Pipe+0xe>
            cprintf("pipe race avoided\n");
  802f98:	c7 04 24 92 49 80 00 	movl   $0x804992,(%esp)
  802f9f:	e8 82 d3 ff ff       	call   800326 <_Z7cprintfPKcz>
...
pipe(int pfd[2])
{
  ...
  803174:	8b 15 20 50 80 00    	mov    0x805020,%edx
  ...
  803189:	8b 15 20 50 80 00    	mov    0x805020,%edx
...
pipe_ipc_recv_read() {
  ...
  8032d5:	c7 04 24 f0 49 80 00 	movl   $0x8049f0,(%esp)
  8032dc:	e8 45 d0 ff ff       	call   800326 <_Z7cprintfPKcz>
  8032e1:	eb 10                	jmp    8032f3 <_Z18pipe_ipc_recv_readv+0x6b>
    else
        cprintf("perm: %x\n", perm);
  8032e3:	89 44 24 04          	mov    %eax,0x4(%esp)
  8032e7:	c7 04 24 a5 49 80 00 	movl   $0x8049a5,(%esp)
  8032ee:	e8 33 d0 ff ff       	call   800326 <_Z7cprintfPKcz>

    cprintf("finished ipc_recv\n");
  8032f3:	c7 04 24 af 49 80 00 	movl   $0x8049af,(%esp)
  8032fa:	e8 27 d0 ff ff       	call   800326 <_Z7cprintfPKcz>
  ...
  80330a:	c7 44 24 0c c2 49 80 	movl   $0x8049c2,0xc(%esp)
  803311:	00 
  803312:	c7 44 24 08 8c 43 80 	movl   $0x80438c,0x8(%esp)
  803319:	00 
  80331a:	c7 44 24 04 8f 00 00 	movl   $0x8f,0x4(%esp)
  803321:	00 
  803322:	c7 04 24 df 49 80 00 	movl   $0x8049df,(%esp)
  803329:	e8 da ce ff ff       	call   800208 <_Z6_panicPKciS0_z>
    
    // set up fd structures
    fd->fd_dev_id = devpipe.dev_id;
  80332e:	8b 15 20 50 80 00    	mov    0x805020,%edx
...
err:
  ...
  803386:	e8 85 08 00 00       	call   803c10 <_Z8ipc_recvPiPvS_>
...
pipe_ipc_send(envid_t envid, int read_fdnum) {
  ...
  8033e0:	e8 ba 08 00 00       	call   803c9f <_Z8ipc_sendijPvi>
    return 0;
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  803436:	c7 44 24 04 13 4a 80 	movl   $0x804a13,0x4(%esp)
  80343d:	00 
...
alloc_sockfd(int sockid)
{
  ...
  80352a:	c3                   	ret    
	...
	sfd->fd_dev_id = devsock.dev_id;
  80352b:	8b 15 3c 50 80 00    	mov    0x80503c,%edx
...
fd2sockid(int fd)
{
  ...
  803573:	b8 f1 ff ff ff       	mov    $0xfffffff1,%eax
	...
	if ((r = fd_lookup(fd, &sfd, 0)) < 0)
		return r;
	if (sfd->fd_dev_id != devsock.dev_id)
  803578:	8b 0d 3c 50 80 00    	mov    0x80503c,%ecx
...
nsipc(unsigned type)
{
  ...
  803691:	00 
  803692:	c7 44 24 08 00 90 80 	movl   $0x809000,0x8(%esp)
  803699:	00 
  80369a:	89 44 24 04          	mov    %eax,0x4(%esp)
  80369e:	c7 04 24 01 11 00 00 	movl   $0x1101,(%esp)
  8036a5:	e8 f5 05 00 00       	call   803c9f <_Z8ipc_sendijPvi>
  ...
  8036c1:	e8 4a 05 00 00       	call   803c10 <_Z8ipc_recvPiPvS_>
}
  8036c6:	c9                   	leave  
  8036c7:	c3                   	ret    
...
nsipc_accept(int s, struct sockaddr *addr, socklen_t *addrlen)
{
  ...
  8036d2:	a3 00 90 80 00       	mov    %eax,0x809000
  ...
  8036e7:	a1 10 90 80 00       	mov    0x809010,%eax
  8036ec:	89 44 24 08          	mov    %eax,0x8(%esp)
  8036f0:	c7 44 24 04 00 90 80 	movl   $0x809000,0x4(%esp)
  8036f7:	00 
  ...
  803703:	8b 15 10 90 80 00    	mov    0x809010,%edx
...
nsipc_shutdown(int s, int how)
{
  ...
  80375e:	a3 00 90 80 00       	mov    %eax,0x809000
	nsipcbuf.shutdown.req_how = how;
  803763:	8b 45 0c             	mov    0xc(%ebp),%eax
  803766:	a3 04 90 80 00       	mov    %eax,0x809004
...
nsipc_close(int s)
{
  ...
  803780:	a3 00 90 80 00       	mov    %eax,0x809000
...
nsipc_listen(int s, int backlog)
{
  ...
  8037d9:	a3 00 90 80 00       	mov    %eax,0x809000
	nsipcbuf.listen.req_backlog = backlog;
  8037de:	8b 45 0c             	mov    0xc(%ebp),%eax
  8037e1:	a3 04 90 80 00       	mov    %eax,0x809004
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  803800:	a3 00 90 80 00       	mov    %eax,0x809000
	nsipcbuf.recv.req_len = len;
  803805:	89 35 04 90 80 00    	mov    %esi,0x809004
	nsipcbuf.recv.req_flags = flags;
  80380b:	8b 45 14             	mov    0x14(%ebp),%eax
  80380e:	a3 08 90 80 00       	mov    %eax,0x809008
  ...
  80382e:	c7 44 24 0c 1f 4a 80 	movl   $0x804a1f,0xc(%esp)
  803835:	00 
  803836:	c7 44 24 08 8c 43 80 	movl   $0x80438c,0x8(%esp)
  80383d:	00 
  80383e:	c7 44 24 04 5f 00 00 	movl   $0x5f,0x4(%esp)
  803845:	00 
  803846:	c7 04 24 34 4a 80 00 	movl   $0x804a34,(%esp)
  80384d:	e8 b6 c9 ff ff       	call   800208 <_Z6_panicPKciS0_z>
		memmove(mem, nsipcbuf.recvRet.ret_buf, r);
  803852:	89 44 24 08          	mov    %eax,0x8(%esp)
  803856:	c7 44 24 04 00 90 80 	movl   $0x809000,0x4(%esp)
  80385d:	00 
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  80387f:	a3 00 90 80 00       	mov    %eax,0x809000
	assert(size < 1600);
  803884:	81 fb 3f 06 00 00    	cmp    $0x63f,%ebx
  80388a:	7e 24                	jle    8038b0 <_Z10nsipc_sendiPKvij+0x3e>
  80388c:	c7 44 24 0c 40 4a 80 	movl   $0x804a40,0xc(%esp)
  803893:	00 
  803894:	c7 44 24 08 8c 43 80 	movl   $0x80438c,0x8(%esp)
  80389b:	00 
  80389c:	c7 44 24 04 6a 00 00 	movl   $0x6a,0x4(%esp)
  8038a3:	00 
  8038a4:	c7 04 24 34 4a 80 00 	movl   $0x804a34,(%esp)
  8038ab:	e8 58 c9 ff ff       	call   800208 <_Z6_panicPKciS0_z>
	memmove(&nsipcbuf.send.req_buf, buf, size);
  8038b0:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  8038b4:	8b 45 0c             	mov    0xc(%ebp),%eax
  8038b7:	89 44 24 04          	mov    %eax,0x4(%esp)
  8038bb:	c7 04 24 0c 90 80 00 	movl   $0x80900c,(%esp)
  8038c2:	e8 15 d2 ff ff       	call   800adc <memmove>
	nsipcbuf.send.req_size = size;
  8038c7:	89 1d 04 90 80 00    	mov    %ebx,0x809004
	nsipcbuf.send.req_flags = flags;
  8038cd:	8b 45 14             	mov    0x14(%ebp),%eax
  8038d0:	a3 08 90 80 00       	mov    %eax,0x809008
...
nsipc_socket(int domain, int type, int protocol)
{
  ...
  8038ee:	a3 00 90 80 00       	mov    %eax,0x809000
	nsipcbuf.socket.req_type = type;
  8038f3:	8b 45 0c             	mov    0xc(%ebp),%eax
  8038f6:	a3 04 90 80 00       	mov    %eax,0x809004
	nsipcbuf.socket.req_protocol = protocol;
  8038fb:	8b 45 10             	mov    0x10(%ebp),%eax
  8038fe:	a3 08 90 80 00       	mov    %eax,0x809008
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  803920:	c7 44 24 04 4c 4a 80 	movl   $0x804a4c,0x4(%esp)
  803927:	00 
...
iscons(int fdnum)
{
  ...
  803a59:	8b 15 58 50 80 00    	mov    0x805058,%edx
...
opencons(void)
{
  ...
  803a9d:	8b 15 58 50 80 00    	mov    0x805058,%edx
  ...
  803aba:	c9                   	leave  
  803abb:	c3                   	ret    
  803abc:	00 00                	add    %al,(%eax)
	...

00803ac0 <_pgfault_upcall>:
...
_pgfault_upcall(struct UTrapframe utf)
{
  ...
  803ac3:	56                   	push   %esi
  803ac4:	53                   	push   %ebx
  803ac5:	83 ec 20             	sub    $0x20,%esp
	int i;
	for (i = NUSER_HANDLERS - 1; i >= 0; --i)
  803ac8:	bb 07 00 00 00       	mov    $0x7,%ebx
		if (user_handlers[i])
  803acd:	8b 04 9d 00 a0 80 00 	mov    0x80a000(,%ebx,4),%eax
  803ad4:	85 c0                	test   %eax,%eax
  803ad6:	74 08                	je     803ae0 <_pgfault_upcall+0x20>
			user_handlers[i](&utf);
  803ad8:	8d 55 08             	lea    0x8(%ebp),%edx
  803adb:	89 14 24             	mov    %edx,(%esp)
  803ade:	ff d0                	call   *%eax
//
asmlinkage void
_pgfault_upcall(struct UTrapframe utf)
{
	int i;
	for (i = NUSER_HANDLERS - 1; i >= 0; --i)
  803ae0:	83 eb 01             	sub    $0x1,%ebx
  803ae3:	83 fb ff             	cmp    $0xffffffff,%ebx
  803ae6:	75 e5                	jne    803acd <_pgfault_upcall+0xd>
		if (user_handlers[i])
			user_handlers[i](&utf);

	panic("[%08x] unhandled page fault at va %08x from eip %08x\n",
  803ae8:	8b 5d 38             	mov    0x38(%ebp),%ebx
  803aeb:	8b 75 08             	mov    0x8(%ebp),%esi
  803aee:	e8 c5 d2 ff ff       	call   800db8 <_Z12sys_getenvidv>
	      sys_getenvid(), utf.utf_fault_va, utf.utf_eip);
  803af3:	89 5c 24 14          	mov    %ebx,0x14(%esp)
  803af7:	89 74 24 10          	mov    %esi,0x10(%esp)
  803afb:	89 44 24 0c          	mov    %eax,0xc(%esp)
  803aff:	c7 44 24 08 58 4a 80 	movl   $0x804a58,0x8(%esp)
  803b06:	00 
  803b07:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
  803b0e:	00 
  803b0f:	c7 04 24 dc 4a 80 00 	movl   $0x804adc,(%esp)
  803b16:	e8 ed c6 ff ff       	call   800208 <_Z6_panicPKciS0_z>

00803b1b <_Z19add_pgfault_handlerPFvP10UTrapframeE>:
...
add_pgfault_handler(pgfault_handler_t handler)
{
  ...
  803b1e:	56                   	push   %esi
  803b1f:	53                   	push   %ebx
  803b20:	83 ec 10             	sub    $0x10,%esp
  803b23:	8b 5d 08             	mov    0x8(%ebp),%ebx
	int r;
    envid_t envid = sys_getenvid();
  803b26:	e8 8d d2 ff ff       	call   800db8 <_Z12sys_getenvidv>
  803b2b:	89 c6                	mov    %eax,%esi
	if (!thisenv->env_pgfault_upcall) {
  803b2d:	a1 00 80 80 00       	mov    0x808000,%eax
  803b32:	8b 40 5c             	mov    0x5c(%eax),%eax
  803b35:	85 c0                	test   %eax,%eax
  803b37:	75 4c                	jne    803b85 <_Z19add_pgfault_handlerPFvP10UTrapframeE+0x6a>
	    if(sys_page_alloc(envid, (void *)(UXSTACKTOP - PGSIZE), PTE_W | PTE_U | PTE_P))
  803b39:	c7 44 24 08 07 00 00 	movl   $0x7,0x8(%esp)
  803b40:	00 
  803b41:	c7 44 24 04 00 f0 ff 	movl   $0xeefff000,0x4(%esp)
  803b48:	ee 
  803b49:	89 34 24             	mov    %esi,(%esp)
  803b4c:	e8 cf d2 ff ff       	call   800e20 <_Z14sys_page_allociPvi>
  803b51:	85 c0                	test   %eax,%eax
  803b53:	74 20                	je     803b75 <_Z19add_pgfault_handlerPFvP10UTrapframeE+0x5a>
	        panic("[%08x] couldn't allocate UXSTACK\n", envid);
  803b55:	89 74 24 0c          	mov    %esi,0xc(%esp)
  803b59:	c7 44 24 08 90 4a 80 	movl   $0x804a90,0x8(%esp)
  803b60:	00 
  803b61:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  803b68:	00 
  803b69:	c7 04 24 dc 4a 80 00 	movl   $0x804adc,(%esp)
  803b70:	e8 93 c6 ff ff       	call   800208 <_Z6_panicPKciS0_z>
        sys_env_set_pgfault_upcall(envid, (void *)_pgfault_upcall);
  803b75:	c7 44 24 04 c0 3a 80 	movl   $0x803ac0,0x4(%esp)
  803b7c:	00 
  803b7d:	89 34 24             	mov    %esi,(%esp)
  803b80:	e8 d0 d4 ff ff       	call   801055 <_Z26sys_env_set_pgfault_upcalliPv>
    }

	// Store handler pointer in our list of handlers.
	for (int i = 0; i < NUSER_HANDLERS; ++i)
		if (user_handlers[i] == handler || !user_handlers[i]) {
  803b85:	a1 00 a0 80 00       	mov    0x80a000,%eax
  803b8a:	39 d8                	cmp    %ebx,%eax
  803b8c:	74 1a                	je     803ba8 <_Z19add_pgfault_handlerPFvP10UTrapframeE+0x8d>
  803b8e:	85 c0                	test   %eax,%eax
  803b90:	74 20                	je     803bb2 <_Z19add_pgfault_handlerPFvP10UTrapframeE+0x97>
	        panic("[%08x] couldn't allocate UXSTACK\n", envid);
        sys_env_set_pgfault_upcall(envid, (void *)_pgfault_upcall);
    }
  ...
  803b92:	b8 01 00 00 00       	mov    $0x1,%eax
		if (user_handlers[i] == handler || !user_handlers[i]) {
  803b97:	8b 14 85 00 a0 80 00 	mov    0x80a000(,%eax,4),%edx
  803b9e:	39 da                	cmp    %ebx,%edx
  803ba0:	74 15                	je     803bb7 <_Z19add_pgfault_handlerPFvP10UTrapframeE+0x9c>
  803ba2:	85 d2                	test   %edx,%edx
  803ba4:	75 1f                	jne    803bc5 <_Z19add_pgfault_handlerPFvP10UTrapframeE+0xaa>
  803ba6:	eb 0f                	jmp    803bb7 <_Z19add_pgfault_handlerPFvP10UTrapframeE+0x9c>
	        panic("[%08x] couldn't allocate UXSTACK\n", envid);
        sys_env_set_pgfault_upcall(envid, (void *)_pgfault_upcall);
    }
  ...
  803bb0:	eb 05                	jmp    803bb7 <_Z19add_pgfault_handlerPFvP10UTrapframeE+0x9c>
  803bb2:	b8 00 00 00 00       	mov    $0x0,%eax
		if (user_handlers[i] == handler || !user_handlers[i]) {
			user_handlers[i] = handler;
  803bb7:	89 1c 85 00 a0 80 00 	mov    %ebx,0x80a000(,%eax,4)
			return;
		}
  ...
  803bc4:	c3                   	ret    
	...
	// Store handler pointer in our list of handlers.
	for (int i = 0; i < NUSER_HANDLERS; ++i)
  803bc5:	83 c0 01             	add    $0x1,%eax
  803bc8:	83 f8 08             	cmp    $0x8,%eax
  803bcb:	75 ca                	jne    803b97 <_Z19add_pgfault_handlerPFvP10UTrapframeE+0x7c>
		if (user_handlers[i] == handler || !user_handlers[i]) {
			user_handlers[i] = handler;
			return;
		}
	...
	panic("[%08x] too many page fault handlers\n", envid);
  803bcd:	89 74 24 0c          	mov    %esi,0xc(%esp)
  803bd1:	c7 44 24 08 b4 4a 80 	movl   $0x804ab4,0x8(%esp)
  803bd8:	00 
  803bd9:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
  803be0:	00 
  803be1:	c7 04 24 dc 4a 80 00 	movl   $0x804adc,(%esp)
  803be8:	e8 1b c6 ff ff       	call   800208 <_Z6_panicPKciS0_z>
  803bed:	00 00                	add    %al,(%eax)
	...
...
resume:
  ...
  803bf3:	5c                   	pop    %esp
    ...
    addl $0x8, %esp
  803bf4:	83 c4 08             	add    $0x8,%esp
    movl 40(%esp), %eax
  803bf7:	8b 44 24 28          	mov    0x28(%esp),%eax
    movl 36(%esp), %ebx
  803bfb:	8b 5c 24 24          	mov    0x24(%esp),%ebx
    subl $4, %ebx
  803bff:	83 eb 04             	sub    $0x4,%ebx
    movl %eax, (%ebx)
  803c02:	89 03                	mov    %eax,(%ebx)
    movl %ebx, 36(%esp)
  803c04:	89 5c 24 24          	mov    %ebx,0x24(%esp)
    popal
  803c08:	61                   	popa   
    popf
  803c09:	9d                   	popf   
...
spin:	jmp spin
  803c0c:	eb fe                	jmp    803c0c <spin>
	...

00803c10 <_Z8ipc_recvPiPvS_>:
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  803c13:	56                   	push   %esi
  803c14:	53                   	push   %ebx
  803c15:	83 ec 10             	sub    $0x10,%esp
  803c18:	8b 5d 08             	mov    0x8(%ebp),%ebx
  803c1b:	8b 45 0c             	mov    0xc(%ebp),%eax
  803c1e:	8b 75 10             	mov    0x10(%ebp),%esi
    int ret;
  ...
  803c23:	ba 00 00 00 ef       	mov    $0xef000000,%edx
  803c28:	0f 44 c2             	cmove  %edx,%eax

    // if there is an error in receiving, null everything out and return
    if ((ret = sys_ipc_recv(pg)) < 0)
  803c2b:	89 04 24             	mov    %eax,(%esp)
  803c2e:	e8 b8 d4 ff ff       	call   8010eb <_Z12sys_ipc_recvPv>
  803c33:	85 c0                	test   %eax,%eax
  803c35:	79 16                	jns    803c4d <_Z8ipc_recvPiPvS_+0x3d>
    {
        if(from_env_store)
  803c37:	85 db                	test   %ebx,%ebx
  803c39:	74 06                	je     803c41 <_Z8ipc_recvPiPvS_+0x31>
            *from_env_store = 0;
  803c3b:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
        if(perm_store)
  803c41:	85 f6                	test   %esi,%esi
  803c43:	74 53                	je     803c98 <_Z8ipc_recvPiPvS_+0x88>
            *perm_store = 0;
  803c45:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
  803c4b:	eb 4b                	jmp    803c98 <_Z8ipc_recvPiPvS_+0x88>
        return ret;
    }
    ...
    if(from_env_store)
  803c4d:	85 db                	test   %ebx,%ebx
  803c4f:	74 17                	je     803c68 <_Z8ipc_recvPiPvS_+0x58>
        *from_env_store = THISENV->env_ipc_from;
  803c51:	e8 62 d1 ff ff       	call   800db8 <_Z12sys_getenvidv>
  803c56:	25 ff 03 00 00       	and    $0x3ff,%eax
  803c5b:	6b c0 78             	imul   $0x78,%eax,%eax
  803c5e:	05 0c 00 00 ef       	add    $0xef00000c,%eax
  803c63:	8b 40 60             	mov    0x60(%eax),%eax
  803c66:	89 03                	mov    %eax,(%ebx)
    if(perm_store)
  803c68:	85 f6                	test   %esi,%esi
  803c6a:	74 17                	je     803c83 <_Z8ipc_recvPiPvS_+0x73>
        *perm_store = THISENV->env_ipc_perm;
  803c6c:	e8 47 d1 ff ff       	call   800db8 <_Z12sys_getenvidv>
  803c71:	25 ff 03 00 00       	and    $0x3ff,%eax
  803c76:	6b c0 78             	imul   $0x78,%eax,%eax
  803c79:	05 00 00 00 ef       	add    $0xef000000,%eax
  803c7e:	8b 40 70             	mov    0x70(%eax),%eax
  803c81:	89 06                	mov    %eax,(%esi)
    return THISENV->env_ipc_value;
  803c83:	e8 30 d1 ff ff       	call   800db8 <_Z12sys_getenvidv>
  803c88:	25 ff 03 00 00       	and    $0x3ff,%eax
  803c8d:	6b c0 78             	imul   $0x78,%eax,%eax
  803c90:	05 08 00 00 ef       	add    $0xef000008,%eax
  803c95:	8b 40 60             	mov    0x60(%eax),%eax
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  803ca3:	56                   	push   %esi
  803ca4:	53                   	push   %ebx
  803ca5:	83 ec 1c             	sub    $0x1c,%esp
  803ca8:	8b 75 08             	mov    0x8(%ebp),%esi
  803cab:	8b 7d 0c             	mov    0xc(%ebp),%edi
  803cae:	8b 5d 10             	mov    0x10(%ebp),%ebx
	// UTOP is above the valid region for ipc mapping
    if (pg == NULL)
  803cb1:	85 db                	test   %ebx,%ebx
        pg = (void *) UTOP;
  803cb3:	b8 00 00 00 ef       	mov    $0xef000000,%eax
  803cb8:	0f 44 d8             	cmove  %eax,%ebx
  ...
  803cbb:	8b 45 14             	mov    0x14(%ebp),%eax
  803cbe:	89 44 24 0c          	mov    %eax,0xc(%esp)
  803cc2:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  803cc6:	89 7c 24 04          	mov    %edi,0x4(%esp)
  803cca:	89 34 24             	mov    %esi,(%esp)
  803ccd:	e8 e1 d3 ff ff       	call   8010b3 <_Z16sys_ipc_try_sendijPvi>
  803cd2:	85 c0                	test   %eax,%eax
  803cd4:	79 31                	jns    803d07 <_Z8ipc_sendijPvi+0x68>
        {
            // yield, since we don't know how long it will take for
            // the other environment to wait for a message
            if (ret == -E_IPC_NOT_RECV)
  803cd6:	83 f8 f9             	cmp    $0xfffffff9,%eax
  803cd9:	75 0c                	jne    803ce7 <_Z8ipc_sendijPvi+0x48>
            {
                sys_yield();
  803cdb:	90                   	nop
  803cdc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  803ce0:	e8 07 d1 ff ff       	call   800dec <_Z9sys_yieldv>
  803ce5:	eb d4                	jmp    803cbb <_Z8ipc_sendijPvi+0x1c>
            }
            else
                panic("ipc_send: %e", ret);
  803ce7:	89 44 24 0c          	mov    %eax,0xc(%esp)
  803ceb:	c7 44 24 08 ea 4a 80 	movl   $0x804aea,0x8(%esp)
  803cf2:	00 
  803cf3:	c7 44 24 04 4f 00 00 	movl   $0x4f,0x4(%esp)
  803cfa:	00 
  803cfb:	c7 04 24 f7 4a 80 00 	movl   $0x804af7,(%esp)
  803d02:	e8 01 c5 ff ff       	call   800208 <_Z6_panicPKciS0_z>
        }
        else
            return;    
}
...
00803d10 <__udivdi3>:
  ...
  803d13:	57                   	push   %edi
  803d14:	56                   	push   %esi
  803d15:	83 ec 20             	sub    $0x20,%esp
  803d18:	8b 45 14             	mov    0x14(%ebp),%eax
  803d1b:	8b 75 08             	mov    0x8(%ebp),%esi
  803d1e:	8b 4d 10             	mov    0x10(%ebp),%ecx
  803d21:	8b 7d 0c             	mov    0xc(%ebp),%edi
  803d24:	85 c0                	test   %eax,%eax
  803d26:	89 75 e8             	mov    %esi,-0x18(%ebp)
  803d29:	89 4d f0             	mov    %ecx,-0x10(%ebp)
  803d2c:	75 3a                	jne    803d68 <__udivdi3+0x58>
  803d2e:	39 f9                	cmp    %edi,%ecx
  803d30:	77 66                	ja     803d98 <__udivdi3+0x88>
  803d32:	85 c9                	test   %ecx,%ecx
  803d34:	75 0b                	jne    803d41 <__udivdi3+0x31>
  803d36:	b8 01 00 00 00       	mov    $0x1,%eax
  803d3b:	31 d2                	xor    %edx,%edx
  803d3d:	f7 f1                	div    %ecx
  803d3f:	89 c1                	mov    %eax,%ecx
  803d41:	89 f8                	mov    %edi,%eax
  803d43:	31 d2                	xor    %edx,%edx
  803d45:	f7 f1                	div    %ecx
  803d47:	89 c7                	mov    %eax,%edi
  803d49:	89 f0                	mov    %esi,%eax
  803d4b:	f7 f1                	div    %ecx
  803d4d:	89 fa                	mov    %edi,%edx
  803d4f:	89 c6                	mov    %eax,%esi
  803d51:	89 75 f0             	mov    %esi,-0x10(%ebp)
  803d54:	89 55 f4             	mov    %edx,-0xc(%ebp)
  803d57:	8b 45 f0             	mov    -0x10(%ebp),%eax
  803d5a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  803d5d:	83 c4 20             	add    $0x20,%esp
  803d60:	5e                   	pop    %esi
  803d61:	5f                   	pop    %edi
  803d62:	5d                   	pop    %ebp
  803d63:	c3                   	ret    
  ...
  803d6a:	31 f6                	xor    %esi,%esi
  803d6c:	39 f8                	cmp    %edi,%eax
  803d6e:	77 e1                	ja     803d51 <__udivdi3+0x41>
  803d70:	0f bd d0             	bsr    %eax,%edx
  803d73:	83 f2 1f             	xor    $0x1f,%edx
  803d76:	89 55 ec             	mov    %edx,-0x14(%ebp)
  803d79:	75 2d                	jne    803da8 <__udivdi3+0x98>
  803d7b:	8b 4d e8             	mov    -0x18(%ebp),%ecx
  803d7e:	39 4d f0             	cmp    %ecx,-0x10(%ebp)
  803d81:	76 06                	jbe    803d89 <__udivdi3+0x79>
  803d83:	39 f8                	cmp    %edi,%eax
  803d85:	89 f2                	mov    %esi,%edx
  803d87:	73 c8                	jae    803d51 <__udivdi3+0x41>
  803d89:	31 d2                	xor    %edx,%edx
  803d8b:	be 01 00 00 00       	mov    $0x1,%esi
  803d90:	eb bf                	jmp    803d51 <__udivdi3+0x41>
  803d92:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  803d98:	89 f0                	mov    %esi,%eax
  803d9a:	89 fa                	mov    %edi,%edx
  803d9c:	f7 f1                	div    %ecx
  803d9e:	31 d2                	xor    %edx,%edx
  803da0:	89 c6                	mov    %eax,%esi
  803da2:	eb ad                	jmp    803d51 <__udivdi3+0x41>
  803da4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  803da8:	0f b6 4d ec          	movzbl -0x14(%ebp),%ecx
  803dac:	89 c2                	mov    %eax,%edx
  803dae:	b8 20 00 00 00       	mov    $0x20,%eax
  803db3:	8b 75 f0             	mov    -0x10(%ebp),%esi
  803db6:	2b 45 ec             	sub    -0x14(%ebp),%eax
  803db9:	d3 e2                	shl    %cl,%edx
  803dbb:	89 c1                	mov    %eax,%ecx
  803dbd:	d3 ee                	shr    %cl,%esi
  803dbf:	0f b6 4d ec          	movzbl -0x14(%ebp),%ecx
  803dc3:	09 d6                	or     %edx,%esi
  803dc5:	89 fa                	mov    %edi,%edx
  803dc7:	89 75 e4             	mov    %esi,-0x1c(%ebp)
  803dca:	8b 75 f0             	mov    -0x10(%ebp),%esi
  803dcd:	d3 e6                	shl    %cl,%esi
  803dcf:	89 c1                	mov    %eax,%ecx
  803dd1:	d3 ea                	shr    %cl,%edx
  803dd3:	0f b6 4d ec          	movzbl -0x14(%ebp),%ecx
  803dd7:	89 75 f0             	mov    %esi,-0x10(%ebp)
  803dda:	8b 75 e8             	mov    -0x18(%ebp),%esi
  803ddd:	d3 e7                	shl    %cl,%edi
  803ddf:	89 c1                	mov    %eax,%ecx
  803de1:	d3 ee                	shr    %cl,%esi
  803de3:	09 fe                	or     %edi,%esi
  803de5:	89 f0                	mov    %esi,%eax
  803de7:	f7 75 e4             	divl   -0x1c(%ebp)
  803dea:	89 d7                	mov    %edx,%edi
  803dec:	89 c6                	mov    %eax,%esi
  803dee:	f7 65 f0             	mull   -0x10(%ebp)
  803df1:	39 d7                	cmp    %edx,%edi
  803df3:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  803df6:	72 12                	jb     803e0a <__udivdi3+0xfa>
  803df8:	8b 55 e8             	mov    -0x18(%ebp),%edx
  803dfb:	0f b6 4d ec          	movzbl -0x14(%ebp),%ecx
  803dff:	d3 e2                	shl    %cl,%edx
  803e01:	39 c2                	cmp    %eax,%edx
  803e03:	73 08                	jae    803e0d <__udivdi3+0xfd>
  803e05:	3b 7d e4             	cmp    -0x1c(%ebp),%edi
  803e08:	75 03                	jne    803e0d <__udivdi3+0xfd>
  803e0a:	83 ee 01             	sub    $0x1,%esi
  803e0d:	31 d2                	xor    %edx,%edx
  803e0f:	e9 3d ff ff ff       	jmp    803d51 <__udivdi3+0x41>
	...

00803e20 <__umoddi3>:
  803e20:	55                   	push   %ebp
  803e21:	89 e5                	mov    %esp,%ebp
  803e23:	57                   	push   %edi
  803e24:	56                   	push   %esi
  803e25:	83 ec 20             	sub    $0x20,%esp
  803e28:	8b 7d 14             	mov    0x14(%ebp),%edi
  803e2b:	8b 45 08             	mov    0x8(%ebp),%eax
  803e2e:	8b 4d 10             	mov    0x10(%ebp),%ecx
  803e31:	8b 75 0c             	mov    0xc(%ebp),%esi
  803e34:	85 ff                	test   %edi,%edi
  803e36:	89 45 e8             	mov    %eax,-0x18(%ebp)
  803e39:	89 4d f4             	mov    %ecx,-0xc(%ebp)
  803e3c:	89 45 f0             	mov    %eax,-0x10(%ebp)
  803e3f:	89 f2                	mov    %esi,%edx
  803e41:	75 15                	jne    803e58 <__umoddi3+0x38>
  803e43:	39 f1                	cmp    %esi,%ecx
  803e45:	76 41                	jbe    803e88 <__umoddi3+0x68>
  803e47:	f7 f1                	div    %ecx
  803e49:	89 d0                	mov    %edx,%eax
  803e4b:	31 d2                	xor    %edx,%edx
  803e4d:	83 c4 20             	add    $0x20,%esp
  803e50:	5e                   	pop    %esi
  803e51:	5f                   	pop    %edi
  803e52:	5d                   	pop    %ebp
  803e53:	c3                   	ret    
  803e54:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  803e58:	39 f7                	cmp    %esi,%edi
  803e5a:	77 4c                	ja     803ea8 <__umoddi3+0x88>
  803e5c:	0f bd c7             	bsr    %edi,%eax
  803e5f:	83 f0 1f             	xor    $0x1f,%eax
  803e62:	89 45 ec             	mov    %eax,-0x14(%ebp)
  803e65:	75 51                	jne    803eb8 <__umoddi3+0x98>
  803e67:	3b 4d f0             	cmp    -0x10(%ebp),%ecx
  803e6a:	0f 87 e8 00 00 00    	ja     803f58 <__umoddi3+0x138>
  803e70:	89 f2                	mov    %esi,%edx
  803e72:	8b 75 f0             	mov    -0x10(%ebp),%esi
  803e75:	29 ce                	sub    %ecx,%esi
  803e77:	19 fa                	sbb    %edi,%edx
  803e79:	89 75 f0             	mov    %esi,-0x10(%ebp)
  803e7c:	8b 45 f0             	mov    -0x10(%ebp),%eax
  803e7f:	83 c4 20             	add    $0x20,%esp
  803e82:	5e                   	pop    %esi
  803e83:	5f                   	pop    %edi
  803e84:	5d                   	pop    %ebp
  803e85:	c3                   	ret    
  803e86:	66 90                	xchg   %ax,%ax
  803e88:	85 c9                	test   %ecx,%ecx
  803e8a:	75 0b                	jne    803e97 <__umoddi3+0x77>
  803e8c:	b8 01 00 00 00       	mov    $0x1,%eax
  803e91:	31 d2                	xor    %edx,%edx
  803e93:	f7 f1                	div    %ecx
  803e95:	89 c1                	mov    %eax,%ecx
  803e97:	89 f0                	mov    %esi,%eax
  803e99:	31 d2                	xor    %edx,%edx
  803e9b:	f7 f1                	div    %ecx
  803e9d:	8b 45 f0             	mov    -0x10(%ebp),%eax
  803ea0:	eb a5                	jmp    803e47 <__umoddi3+0x27>
  803ea2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  803ea8:	89 f2                	mov    %esi,%edx
  803eaa:	83 c4 20             	add    $0x20,%esp
  803ead:	5e                   	pop    %esi
  803eae:	5f                   	pop    %edi
  803eaf:	5d                   	pop    %ebp
  803eb0:	c3                   	ret    
  803eb1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  803eb8:	0f b6 4d ec          	movzbl -0x14(%ebp),%ecx
  803ebc:	89 f2                	mov    %esi,%edx
  803ebe:	8b 45 ec             	mov    -0x14(%ebp),%eax
  803ec1:	c7 45 f0 20 00 00 00 	movl   $0x20,-0x10(%ebp)
  803ec8:	29 45 f0             	sub    %eax,-0x10(%ebp)
  803ecb:	d3 e7                	shl    %cl,%edi
  803ecd:	8b 45 f4             	mov    -0xc(%ebp),%eax
  803ed0:	0f b6 4d f0          	movzbl -0x10(%ebp),%ecx
  803ed4:	d3 e8                	shr    %cl,%eax
  803ed6:	0f b6 4d ec          	movzbl -0x14(%ebp),%ecx
  803eda:	09 f8                	or     %edi,%eax
  803edc:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  803edf:	8b 45 f4             	mov    -0xc(%ebp),%eax
  803ee2:	d3 e0                	shl    %cl,%eax
  803ee4:	0f b6 4d f0          	movzbl -0x10(%ebp),%ecx
  803ee8:	89 45 f4             	mov    %eax,-0xc(%ebp)
  803eeb:	8b 45 e8             	mov    -0x18(%ebp),%eax
  803eee:	d3 ea                	shr    %cl,%edx
  803ef0:	0f b6 4d ec          	movzbl -0x14(%ebp),%ecx
  803ef4:	d3 e6                	shl    %cl,%esi
  803ef6:	0f b6 4d f0          	movzbl -0x10(%ebp),%ecx
  803efa:	d3 e8                	shr    %cl,%eax
  803efc:	0f b6 4d ec          	movzbl -0x14(%ebp),%ecx
  803f00:	09 f0                	or     %esi,%eax
  803f02:	8b 75 e8             	mov    -0x18(%ebp),%esi
  803f05:	f7 75 e4             	divl   -0x1c(%ebp)
  803f08:	d3 e6                	shl    %cl,%esi
  803f0a:	89 75 e8             	mov    %esi,-0x18(%ebp)
  803f0d:	89 d6                	mov    %edx,%esi
  803f0f:	f7 65 f4             	mull   -0xc(%ebp)
  803f12:	89 d7                	mov    %edx,%edi
  803f14:	89 c2                	mov    %eax,%edx
  803f16:	39 fe                	cmp    %edi,%esi
  803f18:	89 f9                	mov    %edi,%ecx
  803f1a:	72 30                	jb     803f4c <__umoddi3+0x12c>
  803f1c:	39 45 e8             	cmp    %eax,-0x18(%ebp)
  803f1f:	72 27                	jb     803f48 <__umoddi3+0x128>
  803f21:	8b 45 e8             	mov    -0x18(%ebp),%eax
  803f24:	29 d0                	sub    %edx,%eax
  803f26:	19 ce                	sbb    %ecx,%esi
  803f28:	0f b6 4d ec          	movzbl -0x14(%ebp),%ecx
  803f2c:	89 f2                	mov    %esi,%edx
  803f2e:	d3 e8                	shr    %cl,%eax
  803f30:	0f b6 4d f0          	movzbl -0x10(%ebp),%ecx
  803f34:	d3 e2                	shl    %cl,%edx
  803f36:	0f b6 4d ec          	movzbl -0x14(%ebp),%ecx
  803f3a:	09 d0                	or     %edx,%eax
  803f3c:	89 f2                	mov    %esi,%edx
  803f3e:	d3 ea                	shr    %cl,%edx
  803f40:	83 c4 20             	add    $0x20,%esp
  803f43:	5e                   	pop    %esi
  803f44:	5f                   	pop    %edi
  803f45:	5d                   	pop    %ebp
  803f46:	c3                   	ret    
  803f47:	90                   	nop
  803f48:	39 fe                	cmp    %edi,%esi
  803f4a:	75 d5                	jne    803f21 <__umoddi3+0x101>
  803f4c:	89 f9                	mov    %edi,%ecx
  803f4e:	89 c2                	mov    %eax,%edx
  803f50:	2b 55 f4             	sub    -0xc(%ebp),%edx
  803f53:	1b 4d e4             	sbb    -0x1c(%ebp),%ecx
  803f56:	eb c9                	jmp    803f21 <__umoddi3+0x101>
  803f58:	39 f7                	cmp    %esi,%edi
  803f5a:	0f 82 10 ff ff ff    	jb     803e70 <__umoddi3+0x50>
  803f60:	e9 17 ff ff ff       	jmp    803e7c <__umoddi3+0x5c>
