 ...
 * Any succeeding arguments are written verbatim to the output file, except
 * arguments like "@2048" will skip to the given sector number.
 *
...
main(int argc, char *argv[])
{
	...
	for (i = 2; i < argc; i++) {
		...
		if (argv[i][0] == '@' && isdigit(argv[i][1])
			...
			if (nsectors > skipto_sector && i != argc - 1) {
