...
// Descriptor data for file system descriptors
struct FdFile {
	int inum;
	char open_path[MAXPATHLEN];
};
...
int	fd_lookup(int fdnum, struct Fd **fd_store, bool must_exist);
int	fd_find_unused(struct Fd **fd_store);
