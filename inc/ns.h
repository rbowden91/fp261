...
union Nsipc {
	...
	struct Nsret_accept acceptRet;
	struct Nsreq_bind bind;
	struct Nsreq_shutdown shutdown;
	struct Nsreq_close close;
	struct Nsreq_connect connect;
	struct Nsreq_listen listen;
	struct Nsreq_recv recv;
	struct Nsret_recv recvRet;
	struct Nsreq_send send;
	struct Nsreq_socket socket;
	struct jif_pkt pkt;
